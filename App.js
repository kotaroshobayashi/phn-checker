...
export default function App() {
  ...
  const handleReset = () => {
    ...
    setRashPhoto(null); setSelectedRegions([]); setPainSide(null);
  };
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.scrollContent} keyboardShouldPersistTaps="handled">
            ...
            {rashPhoto ? (
              <View style={{ gap: 12 }}>
                <Image
                  ...
                  resizeMode="contain"
                />
                <TouchableOpacity onPress={() => setRashPhoto(null)} style={s.dangerBtn}>
              ...
              <CameraCapture onCapture={(uri) => setRashPhoto(uri)} />
            )}
        ...
        {step === 4 && (
          <View style={{ gap: 12 }}>
            ...
            <View style={[s.card, { backgroundColor: risk.bg, borderWidth: 2, borderColor: risk.border }]}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16 }}>
                ...
                <View>
                  ...
                  <Text style={{ fontSize: 11, color: '#9ca3af' }}>スコア：{totalScore}点</Text>
                </View>
              </View>
            </View>
            ...
            {rashPhoto && (
              <View style={s.card}>
                <Text style={s.sectionLabel}>📷 皮疹写真</Text>
                <Image
                  source={{ uri: rashPhoto }}
